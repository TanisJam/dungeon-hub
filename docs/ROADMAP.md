...
|---|---|---|---|
| 0 | **`dm-player-play-model` arc — Slice D** (A ✅ + B ✅ + C ✅ shipped) | **D**: IA tune — Crónica→Bitácora rename, session CTAs on Inicio (player + DM), and codex knowledge-grid discoverability for DMs (folded in from C/W1, diagnosis #1898 entanglement #3). Proposal #1901. | #3.6 DM campaigns + WM playability |
