...
export const COLORS: ColorToken[] = [
  ...
  { name: 'secondary',          hex: '#AB6092', note: 'magenta' },
  { name: 'secondary-deep',     hex: '#B971A2' },
  ...
  { name: 'warning-deep',       hex: '#C78A22' },
  { name: 'danger',             hex: '#CF5050' },
