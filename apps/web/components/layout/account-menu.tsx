      ...
      <V3Sheet open={open} onClose={() => setOpen(false)} title="Cuenta" labelledBy="account-menu-heading">
        <nav aria-label="Cuenta" className="flex flex-col gap-1">
          ...
          >
            ...
            <span className="font-sans text-footnote font-semibold">Mis personajes</span>
          </Link>
          <Link
            href="/campanas"
            onClick={() => setOpen(false)}
          ...
          >
            ...
            <span className="font-sans text-footnote font-semibold">Mis campañas</span>
          </Link>
          <Link
            href="/settings"
            onClick={() => setOpen(false)}
          ...
          >
            ...
            <span className="font-sans text-footnote font-semibold">Ajustes</span>
          </Link>
