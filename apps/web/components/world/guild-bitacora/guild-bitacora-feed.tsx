...
/**
 * GuildBitacoraFeed — unified guild bitácora feed client component.
 *
 * bitacora-gremio W4, ADR-4, ADR-5, ADR-6.
 * REQ-GREM-FD-01, REQ-GREM-FD-02, REQ-GREM-FD-03, REQ-GREM-FD-05.
 * REQ-RENAME-03 (barrido-final): renamed from CronicaFeed → GuildBitacoraFeed.
 *
 * Renders:
...
interface GuildBitacoraFeedProps {
  worldId: string;
  source?: FeedSource;
...
export function GuildBitacoraFeed({
  worldId,
  source,
  initialItems,
  initialTag,
    ...
    <div className="flex flex-col gap-3 pb-20">
      ...
      <div className="fixed bottom-20 right-4 z-50">
        <button
          ...
          className="flex min-h-[44px] items-center gap-2 rounded-pill bg-ink px-5 py-2 text-sm font-semibold text-paper shadow-stamp-md"
