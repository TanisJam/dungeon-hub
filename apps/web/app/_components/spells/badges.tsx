...
export function SpellBadges({ ritual, concentration, componentsM }: SpellBadgesProps) {
  ...
  return (
    <>
      {ritual && (
        <span
          className="rounded-sm bg-warning-soft px-1 text-label font-bold text-warning"
          title="Ritual"
        >
          R
        </span>
      ...
      {concentration && (
        <span
          className="rounded-sm bg-arcane/10 px-1 text-label font-bold text-arcane"
          title="Concentración"
        >
          C
        </span>
      ...
      {componentsM && (
        <span
          className="rounded-sm bg-secondary-soft px-1 text-label font-bold text-secondary"
