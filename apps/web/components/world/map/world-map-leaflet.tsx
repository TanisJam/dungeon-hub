      ...
      {!placement && !creating && !movingPoiId && (
        <>
          ...
          <button
            ...
            className="fixed left-4 z-30 flex min-h-[44px] items-center gap-2 rounded-pill bg-ink px-4 py-2 text-sm font-medium text-surface shadow-stamp-lg md:left-[calc(var(--sidebar-w)+1rem)]"
