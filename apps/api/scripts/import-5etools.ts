      ...
      await tx
        ...
        .values(
          chunk.map((s) => ({
            ...
            componentsM: s.componentsM,
            componentsMCost: s.componentsMCost ?? undefined,
            data: s.data,
            reprintedAs: s.reprintedAs ?? undefined,
          })),
        )
        .onConflictDoUpdate({
          ...
          set: {
            ...
            ritual: sqlExcluded('ritual'),
            concentration: sqlExcluded('concentration'),
            componentsM: sqlExcluded('components_m'),
            componentsMCost: sqlExcluded('components_m_cost'),
            data: sqlExcluded('data'),
            reprintedAs: sqlExcluded('reprinted_as'),
          },
        });
