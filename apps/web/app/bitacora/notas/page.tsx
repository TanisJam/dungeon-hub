 ...
 * REQ-RENAME-01 (barrido-final): route moved from /cronica/notas → /bitacora/notas.
 * Deep-link preserved: /bitacora/notas still resolves (now a facet of the unified feed).
  ...
  if (!aw) {
    return (
      <AppShell
        ...
        callerRole={callerRole}
      >
        <SubNav items={subNavItems} activePath="/bitacora/notas" />
        <V3Empty
          glyph="scroll"
