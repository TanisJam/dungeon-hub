...
// Herramientas Server Actions — Facciones CRUD.
// Biblioteca W1 (ADR-2): moved from /codex/actions.ts, updated revalidatePaths.
...
export async function createFaction(
  ...
  try {
    ...
    revalidatePath('/herramientas/facciones');
...
export async function createNpc(
  ...
  try {
    ...
    revalidatePath('/herramientas/npcs');
    return { ok: true, data: created };
  } catch (err) {
    return handleApiError(err);
  }
...
// ===========================================================================
// getActiveWorldForHerramientas — convenience wrapper for page-level use
// ===========================================================================
